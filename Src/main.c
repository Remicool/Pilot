...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LD2_Blink_GPIO_Port, LD2_Blink_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LD2_Blink_Pin */
  GPIO_InitStruct.Pin = LD2_Blink_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(LD2_Blink_GPIO_Port, &GPIO_InitStruct);
